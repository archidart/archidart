        ...
        if ("root" %in% names(r1)){
          ...
          for (r2 in r1){# For each 2-order root
            ...
            if ("geometry" %in% names(r2)){
              ...
              lie<-lie[order(lie[1:(lie.lines+length2+1), 11], lie[1:(lie.lines+length2+1), 10]),]
              length1<-length1+1
                      ...
                      if (length(which(t>=0 & t<=1))==0){
                        ...
                        if (dist1>min(alldist)){
                          ...
                          if (connect==TRUE){
                            ...
                            lie<-lie[order(lie[1:(lie.lines+length3+1), 11], lie[1:(lie.lines+length3+1), 10]),]
                            length2<-length2+1
                            lie.lines<-lie.lines+1
                            stop2<-stop2+1
                            pos<-match(NA, lie[1:(lie.lines),1])
                            ...
                            if (length(which(t>=0 & t<=1))==0){
                              ...
                              if (dist1>min(alldist)){
                                ...
                                if (connect==TRUE){
                                  ...
                                  lie<-lie[order(lie[1:(lie.lines+length4+1), 11], lie[1:(lie.lines+length4+1), 10]),]
                                  length3<-length3+1
                                  lie.lines<-lie.lines+1
                                  stop3<-stop3+1
                                  pos<-match(NA, lie[1:(lie.lines),1])
                                  ...
                                  if (length(which(t>=0 & t<=1))==0){
                                    ...
                                    if (dist1>min(alldist)){
                                      ...
                                      if (connect==TRUE){
                                        ...
                                        lie<-lie[order(lie[1:(lie.lines+length5+1), 11], lie[1:(lie.lines+length5+1), 10]),]
                                        length4<-length4+1
                                        lie.lines<-lie.lines+1
                                        stop4<-stop4+1
                                        pos<-match(NA, lie[1:(lie.lines),1])
                                        ...
                                        if (length(which(t>=0 & t<=1))==0){
                                          ...
                                          if (dist1>min(alldist)){
                                            ...
                                            if (connect==TRUE){
                                              ...
                                              lie<-lie[order(lie[1:(lie.lines+length6+1), 11], lie[1:(lie.lines+length6+1), 10]),]
                                              length5<-length5+1
                                              lie.lines<-lie.lines+1
                                              stop5<-stop5+1
                                              pos<-match(NA, lie[1:(lie.lines),1])
                                              ...
                                              if (length(which(t>=0 & t<=1))==0){
                                                ...
                                                if (dist1>min(alldist)){
                                                  ...
                                                  if (connect==TRUE){
                                                    ...
                                                    lie<-lie[order(lie[1:(lie.lines+length7+1), 11], lie[1:(lie.lines+length7+1), 10]),]
                                                    length6<-length6+1
                                                    lie.lines<-lie.lines+1
                                                    stop6<-stop6+1
                                                    pos<-match(NA, lie[1:(lie.lines),1])
